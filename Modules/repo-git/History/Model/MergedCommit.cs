...
namespace Palmmedia.GitHistory.Core.Model
{
	...
	internal class MergedCommit : IGitCommit
	{
		...
		/// The parents.
		/// </value>
		public ICollection<IGitCommit> Parents
		{
			get
			{
				var result = new Collection<IGitCommit>();
